(function (global) {
  ...
  function ballsOf(group) {
    return table.balls.filter(function (b) { return b.group === group; })
  ...
  function renderHud(g) {
    ...
    p0balls.innerHTML = a0 ? ballsOf(a0) : ballsOf('solid') + ballsOf('stripe');
    if (g.mode === 'practice') p1balls.innerHTML = '';
    else p1balls.innerHTML = a1 ? ballsOf(a1) : '';
